...
Meteor.publish('trackingViewPub', function(studentId, weekId) {
	...
	let groupId = Meteor.users.findOne({_id: this.userId}).info.groupId;
	let lessons = Lessons.find({studentId: studentId, weekId: weekId}, {sort: {order: 1}, fields: {order: 1, completed: 1, assigned: 1, completedOn: 1, studentId: 1, schoolWorkId: 1, weekId: 1}});
