...
Template.navbar.helpers({
	...
	planningPath: function() {
		...
		if (Session.get('planningPathName') === 'schoolWork') {
			return '/planning/' + Session.get('selectedSchoolWorkId') + '/view/1/' + Session.get('selectedStudentId') +'/'+ Session.get('selectedSchoolYearId') +'/'+ Session.get('selectedSchoolWorkId');
		}
	},
